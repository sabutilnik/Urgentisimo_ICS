...
//	private Map<String,String> tocs;
//
//
...
//	    contentView = inflater.inflate(R.layout.evaluacion_act, container, false);
...
//		actividadesAdapter = new SpinAdapter(getActivity(), android.R.layout.simple_spinner_item, db.getNombreId("actividades"));
...
//		gruposAdapter = new SpinAdapter(getActivity(), android.R.layout.simple_spinner_item, db.getNombreIdSql(stemp, "grupo"));
...
//		LinearLayout alumnosList = (LinearLayout) contentView.findViewById(R.id.lista);
//		alumnosList.removeAllViews();
//		LayoutInflater inflater = (LayoutInflater)getActivity().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//		tocs = db.getMapSql("select * from criterios_actividad where idactividad = '"+actividad.getId()+"'","idcriterio","toc");
//		
//		
...
//			final alumnoEvalInfo alumnoEval = new alumnoEvalInfo(getActivity(), alumnos.get(i).getId(),actividad.getId(), alumnosNombres.get(alumnos.get(i).getId()));	
...
//				final String dbtoc = tocs.get(critid);
////				final String dbtoc = db.getString("select toc from criterios_actividad where idactividad = '"+actividad.getId()+"' and idcriterio = '"+critid+"'");
//				Log.v(TAG,"EL TOC "+dbtoc);
//				final EditText peso = (EditText) cv.findViewById(R.id.etPeso);
//				peso.setText(dbtoc);
